...
export class EcdsaAccountContractInstance extends ContractBase {
  ...
  public static async at(
    ...
    return Contract.at(address, EcdsaAccountContractInstance.artifact, wallet) as Promise<EcdsaAccountContractInstance>;
  }
  ...
  public static deploy(wallet: Wallet, signing_pub_key_x: (bigint | number)[], signing_pub_key_y: (bigint | number)[]) {
    return new DeployMethod<EcdsaAccountContractInstance>(Fr.ZERO, wallet, EcdsaAccountContractArtifact, EcdsaAccountContractInstance.at, Array.from(arguments).slice(1));
  }
  ...
  public static deployWithPublicKeysHash(publicKeysHash: Fr, wallet: Wallet, signing_pub_key_x: (bigint | number)[], signing_pub_key_y: (bigint | number)[]) {
    return new DeployMethod<EcdsaAccountContractInstance>(publicKeysHash, wallet, EcdsaAccountContractArtifact, EcdsaAccountContractInstance.at, Array.from(arguments).slice(2));
  }

  /**
   * Creates a tx to deploy a new instance of this contract using the specified constructor method.
   */
  public static deployWithOpts<M extends keyof EcdsaAccountContractInstance['methods']>(
    opts: { publicKeysHash?: Fr; method?: M; wallet: Wallet },
    ...args: Parameters<EcdsaAccountContractInstance['methods'][M]>
  ) {
    return new DeployMethod<EcdsaAccountContractInstance>(
      opts.publicKeysHash ?? Fr.ZERO,
      opts.wallet,
      EcdsaAccountContractArtifact,
      EcdsaAccountContractInstance.at,
